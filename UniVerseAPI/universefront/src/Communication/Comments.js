...
import {
  ...
  FaChevronDown, FaEnvelope, FaTasks, FaClipboardList, FaRegCommentDots
} from 'react-icons/fa';
    ...
    <div className="d-flex">
      ...
      <div className="flex-grow-1 d-flex justify-content-center align-items-center bg-light vh-100">
        <div className="text-center">
          <FaRegCommentDots size={100} className="text-secondary mb-4" />
          <h4 className="fw-bold">No questions yet</h4>
          <p className="text-muted px-4" style={{ maxWidth: '500px', margin: 'auto' }}>
          Comments is a forum where your students can ask questions, hear your responses,
            and respond to one another. Here’s where you’ll see your courses’ comments.
          </p>
        </div>
      </div>
    </div>
