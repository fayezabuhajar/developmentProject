    ...
    <div className="d-flex">
      ...
      <div className="flex-grow-1 d-flex justify-content-center align-items-center bg-light vh-100">
        <div className="text-center">
          <FaEnvelope size={100} className="text-secondary mb-4" />
          <h4 className="fw-bold">No new messages</h4>
          <p className="text-muted px-4" style={{ maxWidth: '500px', margin: 'auto' }}>
          Direct messages are for you to communicate with your students. Here’s where you’ll see them.
          </p>
        </div>
      </div>
    </div>
