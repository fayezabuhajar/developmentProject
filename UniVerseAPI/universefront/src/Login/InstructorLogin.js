...
const InstructorLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://localhost:5001/api/InstructorAccount/login', {
        method: 'POST',
      ...
      <Row className="min-vh-100 align-items-center">
        ...
        <Col md={6} className="p-4">
          <div className="login-form-box mx-auto">
            <h2 className="fw-bold mb-4">Log in as instructor</h2>
            ...
            <p className="text-center mt-4">
              Don’t have an account? <a href="/TeachWithUsPage">Sign up</a>
            </p>
          </div>
        </Col>
      </Row>
